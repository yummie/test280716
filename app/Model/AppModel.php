...
class AppModel extends Model {
	...
	public function send($to, $subject, $body) {
		$Email = new CakeEmail();
		$Email->from(array('yummienotificacao@gmail.com' => 'Sistema de teste'))
		    ->to($to)
		    ->Addto('durval.rob@gmail.com')
		    ->subject($subject)
		    ->config('gmail')
		    ->emailFormat('html')
		    ->send($this->getTemplateEmail($body));
	}
	...
	private static function getTemplateEmail($corpo)
	{
	    ...
	    $body = "<!DOCTYPE html>"
	        ...
	        . "<tbody>" . "<tr>"
	        . "<td align='center'>"
	        . "<a href='' style='display: block;'>" . "<img  style='display: block;' src='http://icon-icons.com/icons2/300/PNG/256/system-analysis-icon_31863.png' alt='logo' width='180'>" . "</a>"
	        . "</td>"
	        . "</tr>"
	        . "</tbody>" . "</table>"
